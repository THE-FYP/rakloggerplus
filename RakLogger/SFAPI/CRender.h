...
struct API stFontInfo
{
	...
	HRESULT Print( const char *text, D3DCOLOR color, float x, float y, bool shadow, bool noColorFormat = false, frect rect = frect( -1.0f, -1.0f, -1.0f, -1.0f ) );
...
public:		
	CRender( PPLUGININFO pluginInfo );
