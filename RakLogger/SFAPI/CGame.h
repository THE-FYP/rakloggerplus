...
public:		
	...
	void registerWndProcCallback( WndProcCallbackPriority eCallbackPriority, bool ( CALLBACK *pFunc )( HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) );	
	void registerGameDestructorCallback( void ( CALLBACK *pFunc )( void ) )	;

	bool isKeyPressed( byte iKey );
